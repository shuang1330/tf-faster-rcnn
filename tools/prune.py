...
def choose_filters(current_sum,layer_ind,heatmap_all_ind=None,
...
def filter(dic,old_filter_num,new_filter_num,heatmap_path=None,RANDOM=False,MAGNITUTE=False,
...
def prune_net_for_training(tfmodel,weights_path,old_filter_num,new_filter_num,heatmap_path=None,
    ...
    # filter the weights
    dic = filter(dic,old_filter_num,new_filter_num,heatmap_path,RANDOM,MAGNITUTE,CLASSIFICATION_BASED)
...
if __name__ == '__main__':
    ...
    weights_name = 'random_prune_conv11_to128_with_momentum.npy'
    ...
    prune_net_for_training(tfmodel,weights_path,heatmap_path=heatmap_path,
                            SAVE=True,RANDOM=True,MAGNITUTE=False,
                            CLASSIFICATION_BASED=False)
    '''
    ...
    with tf.Graph().as_default() as g2:
        with tf.Session(config=tfconfig,graph=g2).as_default() as sess:
            ...
            experiment_setup = 'prune_layer11_to128'
