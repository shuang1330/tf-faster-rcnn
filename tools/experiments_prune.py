...
if __name__=='__main__':
    ...
    for index_of_layer in [9,10]: # different layer
        ...
        for num_of_filter in [64,128,256]: # different filters for each layer
            new_filter_num[index_of_layer] = num_of_filter
            # load the new grph
            ...
            with tf.Graph().as_default() as g2:
                with tf.Session(config=tfconfig,graph=g2).as_default() as sess:
                    ...
                    for method in ['magnitute']:
                        weights_name = '%s_prune_conv%d_to%d_with_momentum.npy'.format(
                        ...
                        # if method=='classification-based':
                        ...
                        filename = 'demo_pruning/experiments'
                        experiment_setup = '%s/layer%d/to%d'%(method,
                                                index_of_layer,
                                                num_of_filter)
